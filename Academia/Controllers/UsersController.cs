...
namespace Academia.Controllers
{
    public class UsersController : Controller
    {
        ...
        List<string> Roles = new List<string> { "customer", "manager", "staff" };
        ...
        public ActionResult Index()
        {
            try
            {
                ...
                List<Answer> Obj1 = new List<Answer>();
                List<Assessment> Obj2 = new List<Assessment>();
                List<Assignment> Obj3 = new List<Assignment>();
                List<Category> Obj4 = new List<Category>();
                List<Courses> Obj5 = new List<Courses>();
                List<Enrollment> Obj6 = new List<Enrollment>();
                List<Feedback> Obj7 = new List<Feedback>();
                List<Lesson> Obj8 = new List<Lesson>();
                List<Payment> Obj9 = new List<Payment>();
                List<Question> Obj10 = new List<Question>();
                List<Submission> Obj11 = new List<Submission>();

                DashBoared MainObj = new DashBoared{ 
                    User = Obj,
                    Answer = Obj1,
                    Assessment = Obj2,
                    Assignment = Obj3,
                ...
                using (SqlConnection DbCon = new SqlConnection(NewsqlConn))
                {
                    ...
                    SqlCmd.CommandText = @" EXEC sp_fetch_users;
                    EXEC sp_fetch_Courses;
